...
import CouponAdmin from "./components/pages/UserKundli/CouponAdmin";
import Couponss from "./components/vendorPanel/components/pages/Vendors/Couponss";
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/dashboard" element={<Dashbonst oard />} />
        ...
        <Route path='/couponss' element={<Couponss />} />
