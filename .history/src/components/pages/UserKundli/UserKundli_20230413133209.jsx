  ...
  const fetchData = async () => {
    try {
      const { data } = await axios.get(
        `https://oyi65hi3pd.execute-api.ap-south-1.amazonaws.com/development/populartourRouter/getpopulartourVendorId/${vendorId}`
        );
    ...
    const postData = async (e) => {
      ...
      try {
        const { data } = await axios.post(
          ...
          { country, touristDestination, city , vendorId }
        );
        console.log(data);
