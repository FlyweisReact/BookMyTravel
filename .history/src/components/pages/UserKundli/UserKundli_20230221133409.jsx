...
function MyVerticallyCenteredModal(props) {
  ...
  const postData = async (e) => {
    e.preventDefualt()
    try{
      const { data } = await axios.post("https://oyi65hi3pd.execute-api.ap-south-1.amazonaws.com/development/populartourRouter/populartourVendor" , {country })
    }catch(err){
      console.log(err)
    }
  }
    ...
    <MyVerticallyCenteredModal
      ...
      <section>
        <div className="pb-4 sticky top-0  w-full flex justify-between items-center bg-white">
          ...
          <Button variant="outline-success" onClick={() => setModalShow(true)}>Add Tour</Button>
        </div>
