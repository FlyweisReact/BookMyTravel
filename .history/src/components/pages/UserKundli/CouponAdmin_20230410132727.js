...
const CouponAdmin = () => {
  ...
  function MyVerticallyCenteredModal(props) {
    ...
    const postHandler = async (e) => {
      e.preventDefault()
      try{
        const { data } = await axios.post("https://oyi65hi3pd.execute-api.ap-south-1.amazonaws.com/development/coupen/coupenvendor" , {
          coupencode , minimumAmount , activationdate , expirydate , discount
        })
        console.log(data)
        alert('Created')
        props.onHide()
        ...
        <Modal.Body>
          <Form onSubmit={edit ? "" : postHandler}>
            <Form.Group className="mb-3">
              ...
              <Form.Control type="text" onChange={(e) => setCode(e.tar)} />
            </Form.Group>
            <Form.Group className="mb-3">
