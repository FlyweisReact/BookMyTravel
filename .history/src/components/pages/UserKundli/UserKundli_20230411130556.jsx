...
const UserKundli = () => {
  ...
  function MyVerticallyCenteredModal(props) {
    ...
    const putHandler = async (e) => {
      e.preventDefault()
      try{
        const { data } = await axios.put(`https://oyi65hi3pd.execute-api.ap-south-1.amazonaws.com/development/populartourRouter/UpdatepopulartourVendor/63c6029077dc6017f558f653`)
      }catch(e) { 
        console.log(e)
      }
    }
