...
const CouponAdmin = () => {
  ...
  function MyVerticallyCenteredModal(props) {
    ...
    const putHandler = async (e) => {
      ...
      try {
        const { data } = await axios.put(
          `https://oyi65hi3pd.execute-api.ap-south-1.amazonaws.com/development/coupen/updatecoupenvendor/641952f73e61302418d9c623`,
          {
            coupencode,
            minimumAmount,
            activationdate,
    ...
    return (
      ...
      >
        ...
        <Modal.Body>
          <Form onSubmit={edit ? postHandler: postHandler}>
  ...
  const deleteHandler = async (id) => {
    try { 
      const { data } = await axios.delete(`https://oyi65hi3pd.execute-api.ap-south-1.amazonaws.com/development/coupen/deletecoupenvendor/${id}`)
      console.log(data)
      alert('Deleted')
      fetchData()
    }catch(e) { 
