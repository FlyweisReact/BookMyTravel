...
function Horoscope() {
  ...
  const vendorId = localStorage.getItem("")

  const fetchData = async () => {
    try {
      const { data } = await axios.get(
        `https://oyi65hi3pd.execute-api.ap-south-1.amazonaws.com/development/booknowRouter/getbookByVendor/63ca877e8f95721467c65621`
      );
      setData(data);
    } catch (err) {
      console.log(err);
