...
const Discount = () => {
  ...
  function MyVerticallyCenteredModal(props) {
    ...
    const postData = async (e) => {
      e.preventDefault()
      try{
          const { data }  = await axios.post("https://oyi65hi3pd.execute-api.ap-south-1.amazonaws.com/development/packagesRouter/packagesByVendor" , {
            start_date , end_date , price , discount , Type , Activity , touristDestination , location , vendorId : vendorId
          })
          console.log(data)
          props.onHide()
        ...
        <Modal.Body>
          <Form onSubmit={postData}>
            <Form.Group className="mb-3" controlId="formBasicPassword">
              ...
              <Form.Control type="date" onChange={(e) => setStartDate(e.target.valu)} />
            </Form.Group>
            <Form.Group className="mb-3" controlId="formBasicPassword">
