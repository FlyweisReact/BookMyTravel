        ...
        <div style={{ maxWidth: "100%", overflow: "auto" }}>
          <Table striped bordered hover>
            ...
            <tbody>
              {data?.map((i, index) => (
                <tr key={index}>
                  <td> <img src='https://www.shutterstock.com/image-photo/famous-monuments-world-grouped-together-260nw-313571078.jpg' alt='' style={{wi}} /> </td>
                  <td> {i.location} </td>
                  ...
                  <td>
                    <div style={{ display: "flex", gap: "10px" }}>
                      ...
                      <i
                        ...
                        style={{ color: "#A200F6", cursor: "pointer" }}
                      ></i>
