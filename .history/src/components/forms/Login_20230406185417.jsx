  ...
  return (
    <>
      <div className="w-full h-screen flex flex-col justify-center items-center" style={{backgroundColor : '#4b86b4'}}>
        ...
        >
          <p className="text-3xl" style={{color  : '#4b86b4' , fontWeight : '600'}}> Vendor Panel </p>
          <section className="py-7 space-y-6">
            ...
            <button
              type="button"
              onClick={() => navigate("/")}
              className="py-2 cursor-pointer tracking-wider bg-4b86b4-600 flex justify-center items-center w-full rounded-md font-medium   "
            >
              Admin Panel
            </button>
          </section>
