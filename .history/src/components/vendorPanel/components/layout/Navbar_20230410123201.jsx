      ...
      >
        ...
        <section className="flex sm:ml-auto justify-end sm:w-full items-center space-x-2  pr-2">
          <figcaption className="tracking-wider pl-1 font-semibold">
            <div className="lg:text-base text-sm text-#fff-900  uppercase" style={{display : 'flex' ,}}>
              Welcome
              <img src='https://uxwing.com/wp-content/themes/uxwing/download/peoples-avatars/user-profile-icon.png' alt='' style={{width : '40px' , borderRadius : '100%' , cursor: "pointer"}} onClick={() => setModalShow(true)} />
            </div>
          </figcaption>
        </section>
      </div>
