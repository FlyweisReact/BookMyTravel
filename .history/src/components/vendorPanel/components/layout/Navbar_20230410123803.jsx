...
const Navbar = ({ hamb, setHamb }) => {
  ...
  function MyVerticallyCenteredModal(props) {
    ...
    const [profileImage , set ] = useState("")

    const ProfileUpdate = async (e) => {
      try{
        const { data } = await axios.post(`https://oyi65hi3pd.execute-api.ap-south-1.amazonaws.com/development/admminLoginRouter/AdminUpdate/${AdminId}`)
      }catch(e) { 
        console.log(e)
      }
    }
