...
const Users = () => {
  ...
  function MyVerticallyCenteredModal(props) {
    ...
    const postData = async (e) => {
      e.preventDefault()
    try{
      const { data } = await axios.post("https://oyi65hi3pd.execute-api.ap-south-1.amazonaws.com/development/vendorRouter/signupVendor1" , { name, email, phone , password , confirmPassword })
    }catch(err){
      console.log(err)
    }
    } 
