...
const Product = () => {
  ...
  function MyVerticallyCenteredModal(props) {
    ...
    const putHandler =  async (e) => {
      e.preventDefault()
      try{
        const { data} = await axios.put(`https://oyi65hi3pd.execute-api.ap-south-1.amazonaws.com/development/packagesRouter/UpdatePackagesPriceByAdmin/6433cf07c896dd2d851a5e7c` , {
          start_date , 
          end_date , 
          price , 
          discount , 
