        ...
        <Modal.Body>
          <Form onSubmit={putHandler}>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control type="text"    onChange={(e) => setPackageName(e.target.value)} />
            </Form.Group>
            <Form.Group className="mb-3">
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control type="number" min={0}    onChange={(e) => setPackageName(e.target.value)}  />
            </Form.Group>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control type="date"    onChange={(e) => setPackageName(e.target.value)} />
            </Form.Group>
