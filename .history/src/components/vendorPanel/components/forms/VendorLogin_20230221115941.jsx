...
const VendorLogin = () => {
  ...
  const submitHandler = async (e) => {
    ...
    setLoading(true);
    try {
      const { data } = await axios.post("https://oyi65hi3pd.execute-api.ap-south-1.amazonaws.com/development/admminLoginRouter/AdminLogin" ,{ email , password  })
      localStorage.setItem("token" , data.ac)
