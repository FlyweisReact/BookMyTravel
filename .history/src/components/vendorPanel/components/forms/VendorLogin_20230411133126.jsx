...
const VendorLogin = () => {
  ...
  return (
    <>
      <div className="w-full h-screen flex flex-col justify-center items-center bg-slate-100" style={{ backgroundColor: "#659cca" }}>
        <form
          className=" w-96 mx-3 sm:mx-0 sm:w-4/5 md:w-4/6 lg:w-4/5 xl:w-1/2 flex flex-col items-center bg-white p-5 md:py-10 "
          onSubmit={submitHandler}
        >
          <p
            className="text-3xl"
            style={{ color: "#659cca", fontWeight: "600" }}
          >
            {" "}
            Vendor Panel{" "}
          </p>
