...
function MyVerticallyCenteredModal(props) {
  ...
  const putHandler = async (e) => {
    e.preventDefault()
    try{
      const { data } = await axios.put(`https://oyi65hi3pd.execute-api.ap-south-1.amazonaws.com/development/vendorRouter/updateVendor1/${VendorId}` , { name , email , phone , password , confirmPassword })
    }catch(E) {
      console.log(E)
    }
  }
